...
- Understand the core concepts of Prompt Injection Defense
...
Prompt Injection Defense is a fundamental component of AI Guardrails and Safety: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Prompt Injection Defense like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/06-prompt-injection-defense/
```
...
```bash
ls modules/06-prompt-injection-defense/lab/starter/
```
...
cd modules/06-prompt-injection-defense/lab/starter/
```
...
1. What is the main purpose of Prompt Injection Defense?
...
- [ ] Validation script passes: `bash modules/06-prompt-injection-defense/validation/validate.sh`
