...
- Understand the core concepts of PII Detection and Redaction
...
PII Detection and Redaction is a fundamental component of AI Guardrails and Safety: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of PII Detection and Redaction like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/04-pii-detection/lab/starter/
```
...
cd modules/04-pii-detection/lab/starter/
```
...
1. What is the main purpose of PII Detection and Redaction?
...
- [ ] Validation script passes: `bash modules/04-pii-detection/validation/validate.sh`
