# Module 07: Guardrails Frameworks NeMo and Guardrails AI
...
- Understand the core concepts of Guardrails Frameworks NeMo and Guardrails AI
...
### What is Guardrails Frameworks NeMo and Guardrails AI?

Guardrails Frameworks NeMo and Guardrails AI is a fundamental component of AI Guardrails and Safety: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Guardrails Frameworks NeMo and Guardrails AI like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/07-guardrails-frameworks/
```
...
```bash
ls modules/07-guardrails-frameworks/lab/starter/
```
...
cd modules/07-guardrails-frameworks/lab/starter/
```
...
1. What is the main purpose of Guardrails Frameworks NeMo and Guardrails AI?
...
- [ ] Validation script passes: `bash modules/07-guardrails-frameworks/validation/validate.sh`
