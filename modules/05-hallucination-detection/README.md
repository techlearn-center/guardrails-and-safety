...
- Understand the core concepts of Hallucination Detection
...
Hallucination Detection is a fundamental component of AI Guardrails and Safety: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of Hallucination Detection like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
ls modules/05-hallucination-detection/
```
...
```bash
ls modules/05-hallucination-detection/lab/starter/
```
...
cd modules/05-hallucination-detection/lab/starter/
```
...
1. What is the main purpose of Hallucination Detection?
...
- [ ] Validation script passes: `bash modules/05-hallucination-detection/validation/validate.sh`
